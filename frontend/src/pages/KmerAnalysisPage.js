...
export function KmerAnalysisPage() {
    ...
    const [maxZeroPercentage, setMaxZeroPercentage] = useState(savedState?.maxZeroPercentage ?? "100");
    ...
    const handleSubmit = async (event) => {
        ...
        if (!Number.isFinite(parsedMaxZeroPercentage) ||
