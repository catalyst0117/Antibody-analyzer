...
export function FastqProcessingPage() {
    ...
    return (_jsxs("div", { className: "page-grid", children: [_jsxs(SectionCard, { title: "Process FASTQ libraries", description: "Upload sequencing runs to generate ranked peptide matrices with optional background subtraction.", children: [_jsxs("form", { className: "form-grid", onSubmit: handleSubmit, children: [_jsxs("label", { className: "form-field", children: [_jsx("span", { children: "FASTQ files" }), _jsx("input", { type: "file", accept: ".fastq,.fq,.fastq.gz,.fq.gz", multiple: true, onChange: (event) => {
                                            const targetFiles = event.target.files;
                                            setFiles(targetFiles ? Array.from(targetFiles) : []);
                                        } }), _jsx("small", { children: "Supports plain or gzipped FASTQ files. Multiple uploads allowed." })] }), _jsxs("label", { className: "form-field", children: [_jsx("span", { children: "Background FASTQ (optional)" }), _jsx("input", { type: "file", accept: ".fastq,.fq,.fastq.gz,.fq.gz", onChange: (event) => {
